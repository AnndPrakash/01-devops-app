package com.nit.blog.controller;
...
public class UserController {
	...
	public ResponseEntity<ApiResponse>deleteUser(@PathVariable("userId")Integer userId)
	{
		...
		return new ResponseEntity(new ApiResponse("User DeletedSuccessfully",true),HttpStatus.OK);
	...
	@GetMapping("/{userId}")
	public ResponseEntity<UserDto> getSigleUser(@PathVariable Integer userId){
